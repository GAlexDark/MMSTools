...
void MainWindow::setStateText( const QString& state )
{
...
{
    QString contacts = QStringLiteral(
...
void MainWindow::openFileClick()
{
    ...
    m_fileList = QFileDialog::getOpenFileNames( this, tr( "Open MMS Event Log file" ),
