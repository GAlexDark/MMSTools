...
void CElcGuiAppSettingsTest::initTestCase() { removeIniFile(); }

void CElcGuiAppSettingsTest::cleanupTestCase() { removeIniFile(); }
...
void CElcGuiAppSettingsTest::test_fileExists() {
  QString fp = QDir(filePath).filePath(fileName);
  qDebug() << fp;
  QFile file(fp);
...
void CElcGuiAppSettingsTest::test_checkLastDir() {
  CElcGuiAppSettings &settings = CElcGuiAppSettings::instance();
