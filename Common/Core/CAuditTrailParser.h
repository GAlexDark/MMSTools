...
class CAuditTrailParser : public CBasicParser {
  ...
  Q_CLASSINFO("columns",
              "Succeeded;Date;Method;Username;Companyname;Attributes;IpAddress")
  Q_CLASSINFO("ID", "2")
...
public:
  ...
  void getParsedData(QString &status, QDateTime &timestamp, QString &method,
                     QString &username, QString &role, QString &companyname,
                     QString &attributes, QString &username1,
                     QString &internalip, QString &externalip) const;
