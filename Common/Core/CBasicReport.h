...
protected:
  ...
  void setReportDataItem(QXlsx::Document *report, const pBasicDatabase db,
                         const int dbFieldIndex, const int reportFieldIndex,
                         const int row);
  void setReportDataItem(QXlsx::Document *report, const pBasicDatabase db,
                         const QString &dbFieldName, const int reportFieldIndex,
                         const int row);
