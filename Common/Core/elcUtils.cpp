...
QString
elcUtils::getFileErrorMessage(const QFile::FileError error)
{
    QString retVal;
    switch(error)
    {
    ...
    case QFileDevice::ReadError:
        retVal = "An error occurred when reading from the file.";
        break;
    case QFileDevice::WriteError:
        retVal = "An error occurred when writing to the file.";
        break;
    case QFileDevice::FatalError:
        retVal = "A fatal error occurred.";
        break;
    case QFileDevice::ResourceError:
        retVal = "Out of resources (e.g., too many open files, out of memory, etc.)";
        break;
    case QFileDevice::OpenError:
        retVal = "The file could not be opened.";
        break;
    case QFileDevice::AbortError:
        retVal = "The operation was aborted.";
        break;
    case QFileDevice::TimeOutError:
        retVal = "A timeout occurred.";
        break;
    case QFileDevice::UnspecifiedError:
        retVal = "An unspecified error occurred.";
        break;
    case QFileDevice::RemoveError:
        retVal = "The file could not be removed.";
        break;
    case QFileDevice::RenameError:
        retVal = "The file could not be renamed.";
        break;
    case QFileDevice::PositionError:
        retVal = "The position in the file could not be changed.";
        break;
    case QFileDevice::ResizeError:
        retVal = "The file could not be resized.";
        break;
    case QFileDevice::PermissionsError:
        retVal = "The file could not be accessed.";
        break;
    case QFileDevice::CopyError:
        retVal = "The file could not be copied.";
        break;
    default:
        break;
    }
