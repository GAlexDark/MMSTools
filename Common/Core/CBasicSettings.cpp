...
bool CBasicSettings::init(const QString &appPath, const QString &fileName,
                          bool isTerminalMode) {
...
QVariant CBasicSettings::getMain(const QString &keyName) const {
  return m_settings ? m_settings->value(keyName) : QVariant();
}

void CBasicSettings::setMain(const QString &group, const QString &keyName,
