...
protected:
  ...
  bool loadXmlAxisEG_AxShared_Title_Overlay(QXmlStreamReader &reader,
                                            XlsxAxis *axis);
  bool loadXmlAxisEG_AxShared_Title_Tx(QXmlStreamReader &reader,
                                       XlsxAxis *axis);
  bool loadXmlAxisEG_AxShared_Title_Tx_Rich(QXmlStreamReader &reader,
                                            XlsxAxis *axis);
  bool loadXmlAxisEG_AxShared_Title_Tx_Rich_P(QXmlStreamReader &reader,
                                              XlsxAxis *axis);
  bool loadXmlAxisEG_AxShared_Title_Tx_Rich_P_pPr(QXmlStreamReader &reader,
                                                  XlsxAxis *axis);
  bool loadXmlAxisEG_AxShared_Title_Tx_Rich_P_R(QXmlStreamReader &reader,
                                                XlsxAxis *axis);
...
protected:
  ...
  void saveXmlAxisEG_AxShared_Title(QXmlStreamWriter &writer,
                                    XlsxAxis *axis) const;
