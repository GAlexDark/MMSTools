...
class QXLSX_EXPORT Document : public QObject {
  Q_OBJECT
  Q_DECLARE_PRIVATE(
      Document) // D-Pointer. Qt classes have a Q_DECLARE_PRIVATE
...
public:
  ...
  bool write(const CellReference &cell, const QVariant &value,
  ...
  bool changeimage(int filenoinmidea,
                   QString newfile); // add by liufeijin20181025
