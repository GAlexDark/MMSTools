...
protected:
  ...
  QString xsp_cNvPR_name,
      xsp_cNvPR_id; // x measns shape and cxnSp together using
  ...
  QString Style_inref_idx, style_fillref_idx, style_effectref_idx,
      style_forntref_idx;
  QString Style_inref_val, style_fillref_val, style_effectref_val,
      style_forntref_val;
  // liufeij }}
};
