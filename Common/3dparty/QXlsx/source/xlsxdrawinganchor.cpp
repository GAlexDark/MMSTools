...
DrawingAnchor::DrawingAnchor(Drawing *drawing, ObjectType objectType)
  ...
  m_id =
      m_drawing->anchors.size(); // must be unique in one drawing{x}.xml file.
}
...
void DrawingAnchor::setObjectPicture(const QImage &img) {
  ...
  m_pictureFile = std::make_shared<MediaFile>(ba, QStringLiteral("png"),
...
int DrawingAnchor::row() const { return -1; }

int DrawingAnchor::col() const { return -1; }
...
XlsxMarker DrawingAnchor::loadXmlMarker(QXmlStreamReader &reader,
                                        const QString &node) {
...
void DrawingAnchor::loadXmlObject(QXmlStreamReader &reader) {
  ...
  */
  ...
  if (reader.name() ==
      QLatin1String("sp")) // <xsd:element name="sp" type="CT_Shape"/>
  {
    // Shape
    m_objectType = Shape;
    ...
    //{{ liufeijin
    sp_textlink =
        reader.attributes().value(QLatin1String("textlink")).toString();
    sp_macro = reader.attributes().value(QLatin1String("macro")).toString();
    //}}

    // <xsd:attribute name="macro" type="xsd:string" use="optional"/>
    // <xsd:attribute name="textlink" type="xsd:string" use="optional"/>
    // <xsd:attribute name="fLocksText" type="xsd:boolean" use="optional"
    // default="true"/> <xsd:attribute name="fPublished" type="xsd:boolean"
    // use="optional" default="false"/>

    loadXmlObjectShape(reader); // CT_Shape
  } else if (reader.name() ==
             QLatin1String(
                 "grpSp")) // <xsd:element name="grpSp" type="CT_GroupShape"/>
  {
    // Group Shape
    m_objectType = GroupShape;
    loadXmlObjectGroupShape(reader);
  } else if (reader.name() ==
             QLatin1String("graphicFrame")) // <xsd:element name="graphicFrame"
                                            // type="CT_GraphicalObjectFrame"/>
  {
    ...
    loadXmlObjectGraphicFrame(reader);
             ...
             QLatin1String(
                 "cxnSp")) // <xsd:element name="cxnSp" type="CT_Connector"/>
  {
    // Connection Shape
    ...
    loadXmlObjectConnectionShape(reader);
             ...
             QLatin1String(
                 "pic")) // <xsd:element name="pic" type="CT_Picture"/>
  {
    // Picture
    m_objectType = Picture;
    loadXmlObjectPicture(reader);
  } else if (reader.name() ==
             QLatin1String("contentPart")) // <xsd:element name="contentPart"
                                           // type="CT_Rel"/>
  {
    // contentPart
    /// TODO:
  ...
  while (!reader.atEnd()) {
    ...
    if (reader.tokenType() == QXmlStreamReader::StartElement) {
      if (reader.name() == QLatin1String("cNvPr")) {
        ...
        xprstGeom_prst = reader.attributes()
                             .value(QLatin1String("prst"))
                             .toString()
                             .trimmed();
      } else if (reader.name() == QLatin1String("ln")) {
        xIn_algn = reader.attributes()
                       .value(QLatin1String("algn"))
                       .toString()
                       .trimmed();
        xIn_cmpd = reader.attributes()
                       .value(QLatin1String("cmpd"))
                       .toString()
                       .trimmed();
        xIn_cap = reader.attributes()
                      .value(QLatin1String("cap"))
                      .toString()
                      .trimmed();
        xIn_w =
            reader.attributes().value(QLatin1String("w")).toString().trimmed();
      } else if (reader.name() == QLatin1String("headEnd")) {
        x_headEnd_w =
            reader.attributes().value(QLatin1String("w")).toString().trimmed();
        x_headEnd_len = reader.attributes()
                            .value(QLatin1String("len"))
                            .toString()
                            .trimmed();
        x_headEnd_tyep = reader.attributes()
        ...
        x_tailEnd_w =
            reader.attributes().value(QLatin1String("w")).toString().trimmed();
        x_tailEnd_len = reader.attributes()
                            .value(QLatin1String("len"))
                            .toString()
                            .trimmed();
        x_tailEnd_tyep = reader.attributes()
                             .value(QLatin1String("type"))
                             .toString()
                             .trimmed();
      } else if (reader.name() == QLatin1String("lnRef")) {
        Style_inref_idx = reader.attributes()
                              .value(QLatin1String("idx"))
                              .toString()
                              .trimmed();
        reader.readNextStartElement();
        if (reader.tokenType() == QXmlStreamReader::StartElement) {
          if (reader.name() == QLatin1String("schemeClr")) {
            Style_inref_val = reader.attributes()
        ...
        style_fillref_idx = reader.attributes()
                                .value(QLatin1String("idx"))
                                .toString()
                                .trimmed();
        reader.readNextStartElement();
        if (reader.tokenType() == QXmlStreamReader::StartElement) {
          if (reader.name() == QLatin1String("schemeClr")) {
            style_fillref_val = reader.attributes()
                                    .value(QLatin1String("val"))
                                    .toString()
                                    .trimmed();
          }
        ...
        style_effectref_idx = reader.attributes()
                                  .value(QLatin1String("idx"))
                                  .toString()
                                  .trimmed();
        reader.readNextStartElement();
        if (reader.tokenType() == QXmlStreamReader::StartElement) {
          if (reader.name() == QLatin1String("schemeClr")) {
            style_effectref_val = reader.attributes()
                                      .value(QLatin1String("val"))
                                      .toString()
                                      .trimmed();
          }
        ...
        style_forntref_idx = reader.attributes()
                                 .value(QLatin1String("idx"))
                                 .toString()
                                 .trimmed();
        reader.readNextStartElement();
        if (reader.tokenType() == QXmlStreamReader::StartElement) {
          if (reader.name() == QLatin1String("schemeClr")) {
            style_forntref_val = reader.attributes()
                                     .value(QLatin1String("val"))
                                     .toString()
                                     .trimmed();
          }
  ...
  while (!reader.atEnd()) {
    ...
    if (reader.tokenType() == QXmlStreamReader::StartElement) {
      if (reader.name() == QLatin1String("chart")) {
        QString rId =
            reader.attributes().value(QLatin1String("r:id")).toString();
        QString name =
            m_drawing->relationships()->getRelationshipById(rId).target;

        const auto parts = splitPath(m_drawing->filePath());
        QString path =
            QDir::cleanPath(parts.first() + QLatin1String("/") + name);
        ...
        if (!exist) {
          m_chartFile = QSharedPointer<Chart>(
  ...
  while (!reader.atEnd()) {
    ...
    if (reader.tokenType() == QXmlStreamReader::StartElement) {
      if (reader.name() == QLatin1String("blip")) {
        QString rId =
            reader.attributes().value(QLatin1String("r:embed")).toString();
        QString name =
            m_drawing->relationships()->getRelationshipById(rId).target;
...
void DrawingAnchor::loadXmlObjectShape(QXmlStreamReader &reader) {
  ...
  <xsd:complexType name="CT_Shape">
      <xsd:sequence>
          <xsd:element name="nvSpPr" type="CT_ShapeNonVisual" minOccurs="1"
  maxOccurs="1"/> <xsd:element name="spPr" type="a:CT_ShapeProperties"
  minOccurs="1" maxOccurs="1"/> <xsd:element name="style" type="a:CT_ShapeStyle"
  minOccurs="0" maxOccurs="1"/> <xsd:element name="txBody" type="a:CT_TextBody"
  ...
  */
  ...
  maxOccurs="1"/> <xsd:element name="cNvSpPr"
  ...
  */
  ...
  reader.attributes().value(QLatin1String("r:embed")).toString();
              ...
              rId=sp_blip_rembed;
              QString name =
  m_drawing->relationships()->getRelationshipById(rId).target; QString path =
  QDir::cleanPath(splitPath(m_drawing->filePath())[0] + QLatin1String("/") +
  name); bool exist = false; QList<QSharedPointer<MediaFile> > mfs =
  m_drawing->workbook->mediaFiles(); for (int i=0; i<mfs.size(); ++i)
                 ...
                 if (!exist) {
                     m_pictureFile = QSharedPointer<MediaFile> (new
  MediaFile(path)); m_drawing->workbook->addMediaFile(m_pictureFile, true);
                 }
          }
          else if (reader.name() == QLatin1String("off"))
          {
          ...
          else if(reader.name() == QLatin1String("blipFill"))
          {
              ...
              rotWithShapeTA =
  reader.attributes().value(QLatin1String("rotWithShape")).toString().toInt();
  dpiTA = reader.attributes().value(QLatin1String("dpi")).toString().toInt();

              // rotWithShapeTA =
  reader.attributes().value(QLatin1String("rotWithShape")).toInt();
              // dpiTA =
  reader.attributes().value(QLatin1String("dpi")).toInt();

          }else if(reader.name() == QLatin1String("cNvPr"))
          {
             xsp_cNvPR_name=
  reader.attributes().value(QLatin1String("name")).toString(); xsp_cNvPR_id=
  reader.attributes().value(QLatin1String("id")).toString();
          }
          else if(reader.name() == QLatin1String("spPr"))
          {
              xbwMode=
  reader.attributes().value(QLatin1String("bwMode")).toString();
          }
          else if(reader.name() == QLatin1String("prstGeom"))
          {
              xprstGeom_prst=
  reader.attributes().value(QLatin1String("prst")).toString();
          }
          else if(reader.name() == QLatin1String("ln"))
          {
              xIn_algn=
  reader.attributes().value(QLatin1String("algn")).toString(); xIn_cmpd=
  reader.attributes().value(QLatin1String("cmpd")).toString(); xIn_cap=
  reader.attributes().value(QLatin1String("cap")).toString(); xIn_w=
  reader.attributes().value(QLatin1String("w")).toString();
          }
          else if(reader.name() == QLatin1String("headEnd"))
          {
              x_headEnd_w=
  reader.attributes().value(QLatin1String("w")).toString(); x_headEnd_len=
  reader.attributes().value(QLatin1String("len")).toString(); x_headEnd_tyep=
  reader.attributes().value(QLatin1String("type")).toString();
          }
          else if(reader.name() == QLatin1String("tailEnd"))
          {
              x_tailEnd_w=
  reader.attributes().value(QLatin1String("w")).toString(); x_tailEnd_len=
  reader.attributes().value(QLatin1String("len")).toString(); x_tailEnd_tyep=
  reader.attributes().value(QLatin1String("type")).toString();
          }
          else if(reader.name() == QLatin1String("lnRef"))
          {
...
void DrawingAnchor::saveXmlPos(QXmlStreamWriter &writer,
...
void DrawingAnchor::saveXmlExt(QXmlStreamWriter &writer,
                               const QSize &ext) const {
...
void DrawingAnchor::saveXmlMarker(QXmlStreamWriter &writer,
  ...
  writer.writeTextElement(QStringLiteral("xdr:col"),
                          QString::number(marker.col()));
  writer.writeTextElement(QStringLiteral("xdr:colOff"),
                          QString::number(marker.colOff()));
  writer.writeTextElement(QStringLiteral("xdr:row"),
                          QString::number(marker.row()));
  writer.writeTextElement(QStringLiteral("xdr:rowOff"),
                          QString::number(marker.rowOff()));
...
void DrawingAnchor::saveXmlObjectConnectionShape(
  ...
  if ((!x_headEnd_tyep.isEmpty()) || (!x_headEnd_w.isEmpty()) ||
      (!x_headEnd_len.isEmpty())) {
  ...
  if ((!x_tailEnd_tyep.isEmpty()) || (!x_tailEnd_w.isEmpty()) ||
      (!x_tailEnd_len.isEmpty())) {
...
void DrawingAnchor::saveXmlObjectGraphicFrame(QXmlStreamWriter &writer) const {
  ...
  writer.writeAttribute(QStringLiteral("name"),
                        QStringLiteral("Chart %1").arg(m_id));
...
void DrawingAnchor::saveXmlObjectPicture(QXmlStreamWriter &writer) const {
  ...
  writer.writeAttribute(QStringLiteral("id"),
                        QString::number(m_id + 1)); // liufeijin
  writer.writeAttribute(QStringLiteral("name"),
                        QStringLiteral("Picture %1").arg(m_id));
  ...
  m_drawing->relationships()->addDocumentRelationship(
      QStringLiteral("/image"), QStringLiteral("../media/image%1.%2")
...
int DrawingAnchor::getm_id() { return (this->m_id); }
...
void DrawingAnchor::saveXmlObjectShape(QXmlStreamWriter &writer) const {
  ...
  if (m_pictureFile) {
    ...
    writer.writeAttribute(QStringLiteral("rotWithShape"),
                          QString::number(rotWithShapeTA));
...
DrawingAbsoluteAnchor::DrawingAbsoluteAnchor(Drawing *drawing,
...
DrawingOneCellAnchor::DrawingOneCellAnchor(Drawing *drawing,
                                           ObjectType objectType)
    : DrawingAnchor(drawing, objectType) {}

int DrawingOneCellAnchor::row() const { return from.row(); }

int DrawingOneCellAnchor::col() const { return from.col(); }
...
*/
DrawingTwoCellAnchor::DrawingTwoCellAnchor(Drawing *drawing,
                                           ObjectType objectType)
    : DrawingAnchor(drawing, objectType) {}

int DrawingTwoCellAnchor::row() const { return from.row(); }

int DrawingTwoCellAnchor::col() const { return from.col(); }
...
bool DrawingTwoCellAnchor::loadFromXml(QXmlStreamReader &reader) {
  ...
  <xsd:complexType name="CT_TwoCellAnchor">
      <xsd:sequence>
          ...
          <xsd:element name="clientData" type="CT_AnchorClientData"
  ...
  while (!reader.atEnd()) {
    ...
    if (reader.tokenType() == QXmlStreamReader::StartElement) {
      if (reader.name() == QLatin1String("from")) {
        ...
        type="CT_GraphicalObjectFrame"/> <xsd:element name="cxnSp"
        type="CT_Connector"/> <xsd:element name="pic" type="CT_Picture"/>
                    <xsd:element name="contentPart" type="CT_Rel"/>
                </xsd:choice>
            </xsd:sequence>
        </xsd:group>
...
void DrawingTwoCellAnchor::saveToXml(QXmlStreamWriter &writer) const {
  ...
  if (!editASName.isNull()) {
    writer.writeAttribute(QStringLiteral("editAs"),
                          editASName); // QStringLiteral("oneCell")
  }
  // }}
