...
RichStringPrivate::RichStringPrivate(const RichStringPrivate &other)
    : QSharedData(other), fragmentTexts(other.fragmentTexts),
      fragmentFormats(other.fragmentFormats), _idKey(other.idKey()),
      _dirty(other._dirty) {}
 ...
 */
bool RichString::isNull() const { return d->fragmentTexts.size() == 0; }
 ...
 */
int RichString::fragmentCount() const { return d->fragmentTexts.size(); }
