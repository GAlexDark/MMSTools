...
void CElcConsoleAppSettings::createDefault(const QString &iniPath) {
...
bool CElcConsoleAppSettings::isDataHasHeaders() const {
  QString buf =
      getMain(QLatin1String("SETTINGS/data_has_headers")).toString().trimmed();
